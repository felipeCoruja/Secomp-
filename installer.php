...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20220925_secomp_5d3bcf1f48735bbd3044_20220925211952_archive.zip';
        const ARCHIVE_SIZE       = '37914805';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '5d3bcf1-25211952';
        const SECONDARY_PACKAGE_HASH = '2530409-25211952';
        const VERSION            = '1.5.0';
